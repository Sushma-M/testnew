...
@Service
public class CropdataQueryExecutorServiceImpl implements CropdataQueryExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(CropdataQueryExecutorServiceImpl.class);

    @Autowired
    @Qualifier("cropdataWMQueryExecutor")
