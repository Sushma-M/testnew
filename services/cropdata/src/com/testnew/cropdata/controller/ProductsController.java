...
import com.testnew.cropdata.service.ProductsService;
 ...
 * @see Products
 */
@RestController("cropdata.ProductsController")
@Api(value = "ProductsController", description = "Exposes APIs to work with Products resource.")
@RequestMapping("/cropdata/Products")
public class ProductsController {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProductsController.class);

    @Autowired
	@Qualifier("cropdata.ProductsService")
