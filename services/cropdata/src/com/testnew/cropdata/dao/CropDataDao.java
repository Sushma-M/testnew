...
/**
 * Specifies methods used to obtain and modify CropData related information
 * which is stored in the database.
 */
@Repository("cropdata.CropDataDao")
public class CropDataDao extends WMGenericDaoImpl<CropData, Integer> {
